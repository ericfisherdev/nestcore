...
//
// Nothing here may be used by production code. A composition root builds its
// hasher from crypto.DefaultParams; a build that reaches this package outside
// a test has selected deliberately breakable parameters.
package cryptotest

import "github.com/ericfisherdev/nestcore/crypto"
